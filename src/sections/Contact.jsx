  ...
  return (
    <section
      ...
      <div className="relative z-10">
        ...
        <div className="flex px-10 font-light text-yellow-300 uppercase lg:text-[32px] text-[26px] leading-none mb-10">
      ...
      <Marquee
        items={items}
        className="relative z-10 text-yellow-300 bg-transparent"
      />
    </section>
  );
};
